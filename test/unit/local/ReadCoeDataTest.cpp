...
class ReadCoeDataTest : public TestModule::Impl {
public:
    ReadCoeDataTest();
...
ReadCoeDataTest::ReadCoeDataTest() {
...
std::vector<TestCase> ReadCoeDataTest::getTestCases() {
    return {
        {"Valid InputFile", []() {
...
TestModule readCoeDataTest() {
    return {
        "Read Coefficient data Test",
        []() { return std::make_unique<ReadCoeDataTest>(); }
    };
}
